...
// ── /executors command (single dropdown with all 4 options) ──

function execListCmd() {
  return reply({
    content: "Select your executor category:",
    components: [{
      type: 1,
      components: [{
        type: 3,
        ...
        options: [
          { label: "PC — Paid", value: "exec_cat_pc_paid", emoji: { name: "💻" }, description: "Paid PC executors" },
          { label: "PC — Free", value: "exec_cat_pc_free", emoji: { name: "🖥️" }, description: "Free PC executors" },
          { label: "Mobile — Android", value: "exec_cat_mob_android", emoji: { name: "📱" }, description: "Android mobile executors" },
          { label: "Mobile — iOS", value: "exec_cat_mob_ios", emoji: { name: "🍎" }, description: "iOS mobile executors" },
        ]
      }]
    }]
  });
